...
public class HomePage extends PageObject {
    ...
    @FindBy(xpath = "//*[@class='tab-content']//*[@id='homefeatured']//*[contains(text(),'')]//ancestor::*[contains(@class,'ajax')]//*[@itemprop='name']")
    ...
    public List<String> getProductNameList() {
        return listOfProductNames.stream().map(WebElementFacade::getText).collect(Collectors.toList());
    }
}
